...
public class GetRateApi {
     ...
     */
    public GetRateApi(String secretId, String pkPath, String speechResultUrl) {
        if (null == speechResultUrl) {
            speechResultUrl = ConfigUtil.NET_WORK.RATE_API;
        }
    ...
    public JSONObject getRate() {
        ...
        try {
            // 返回网络请求数据
            classificationResult = HttpConnectionUtil.getSecretInfo(url, timestamp, nonce, signature);
