...
public class SpeechSyncApi {
     ...
     * @param url      请求接口地址
     */
    public SpeechSyncApi(String secretId, String pkPath, String url) {
        if (null == url) {
            url = ConfigUtil.NET_WORK.SPEECH_SYNC_API_URI;
        }

        this.secretId = secretId;
        this.url = url + secretId;
     ...
     * @return
     */
    public JSONObject doSpeechSyncApi(String[] speech, String taskId, String speechType) {
